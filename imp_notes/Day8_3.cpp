...
class Complex 
{
    ...
    Complex operator+=(Complex other)
    {
        ...
        return *this;  //IMP (here *this is used because we have to update the value in the existing object using +=)
    }
    //this = &c2 
    //other = c1 
...
{
    Complex c1(10,20); 
    Complex c2 = c1++; //c2 = c1.operator++(0); (While postincrement 0 value is passed in the parameter) //IMP
